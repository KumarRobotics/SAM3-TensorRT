...
const std::vector<std::pair<std::string,std::string>>& CLIPTokenizer::getMerges() const { return merges_; }

const std::unordered_map<std::string,int>& CLIPTokenizer::getVocab()  const { return vocab_; }
